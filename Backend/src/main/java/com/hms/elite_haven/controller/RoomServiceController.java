...
public class RoomServiceController {
    ...
    // Create a new room service or update an existing one
    ...
    // Get all available room services
    ...
    // Get a specific room service by ID
    ...
    // Get all services used for a particular booking
    ...
    // Get all services associated with a particular room
